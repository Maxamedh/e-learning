...
<div class="container">
    ...
    <section class="mb-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="<?= base_url('portal/my-courses') ?>" class="btn btn-link">View All <i
        ...
        <div class="row g-4">
            ...
            <div class="col-6 col-md-4 col-lg-3">
                <?php 
                    ...
                    ?>
                <a href="<?= $cardHref ?>" class="<?= $cardClass ?>"
                    <?= $isPending ? 'onclick="return false;" style="cursor: not-allowed; opacity: 0.7;"' : '' ?>>
                    <?php if (!empty($enrollment['thumbnail_url'])): ?>
                    <img src="<?= esc($enrollment['thumbnail_url']) ?>" alt="<?= esc($enrollment['title']) ?>"
                        style="width: 100%; height: 150px; object-fit: cover;">
                    <?php else: ?>
                    <div
                        style="height: 150px; background: #e0e0e0; display: flex; align-items: center; justify-content: center;">
                    ...
                    <div class="p-3">
                        ...
                        <div class="progress-bar-container" style="height: 8px; margin-bottom: 8px;">
                            <div class="progress-bar-fill"
                                style="width: <?= $enrollment['progress_percentage'] ?? 0 ?>%; transition: width 0.3s ease;">
                            </div>
                        </div>
