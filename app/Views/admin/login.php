...
<head>
    ...
    <title><?= $title ?? 'Admin & Instructor Login' ?> - E-LOOX Academy</title>
    ...
    <div class="admin-login-container">
        <div class="admin-login-card">
            ...
            <div class="admin-logo">
                <img src="<?= base_url('logo/jpg/logo@3x-100.jpg') ?>" alt="E-LOOX Academy Logo"
                    onerror="this.src='<?= base_url('assets/images/logo.png') ?>'">
            </div>

            <h2 class="admin-title text-center">Admin & Instructor Login</h2>
            <p class="admin-subtitle text-center">Sign in to access the admin/instructor panel</p>
            ...
            <form method="POST" action="<?= base_url('admin/login') ?>" id="loginForm">
                ...
                <!-- Login Button -->
                <button type="submit" id="loginBtn" class="btn btn-primary btn-lg w-100 rounded-3 mb-3"
            ...
            <div class="text-center">
                <p class="text-muted small mb-0">Student Portal? <a href="<?= base_url() ?>" class="text-primary">Go to
                        Portal</a></p>
            </div>
        </div>
    </div>
